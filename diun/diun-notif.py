...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="Note: For notifications to appear in KDE history, the --desktop-entry must match an existing .desktop file (e.g., ~/.local/share/applications/diun.desktop).",
    )
    parser.add_argument(
        "--port",
        type=int,
